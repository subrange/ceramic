...
void ceramic_x86_vector(__m128i x, __m128 y, __m128d z);
void ceramic_x86_2(struct Struct_x86_2 x);
void ceramic_x86_3(struct Struct_x86_3 x);
void ceramic_x86_4(struct Struct_x86_4 x);
void ceramic_x86_5(struct Struct_x86_5 x);
void ceramic_x86_6(struct Struct_x86_6 x);
void ceramic_x86_7(struct Struct_x86_7 x);
void ceramic_x86_10(union Union_x86_10 x, int tag);
void ceramic_x86_11(union Union_x86_11 x, int tag);

//
// return
//

__m128i ceramic_x86_return_int_vector(void);
__m128 ceramic_x86_return_float_vector(void);
__m128d ceramic_x86_return_double_vector(void);
struct Struct_x86_2 ceramic_x86_return_2(void);
struct Struct_x86_3 ceramic_x86_return_3(void);
struct Struct_x86_4 ceramic_x86_return_4(void);
struct Struct_x86_5 ceramic_x86_return_5(void);
struct Struct_x86_6 ceramic_x86_return_6(void);
struct Struct_x86_7 ceramic_x86_return_7(void);
union Union_x86_10 ceramic_x86_return_10(int tag);
union Union_x86_11 ceramic_x86_return_11(int tag);

void c_to_ceramic_x86(void) {
    printf("\nPassing C arguments to Ceramic:\n");
    fflush(stdout);

    ceramic_x86_vector(c_x86_return_int_vector(),
        c_x86_return_float_vector(), c_x86_return_double_vector());

    ceramic_x86_2(c_x86_return_2());
    ceramic_x86_3(c_x86_return_3());
    ceramic_x86_4(c_x86_return_4());
    ceramic_x86_5(c_x86_return_5());
    ceramic_x86_6(c_x86_return_6());
    ceramic_x86_7(c_x86_return_7());

    ceramic_x86_10(c_x86_return_10(0), 0);
    ceramic_x86_10(c_x86_return_10(1), 1);

    ceramic_x86_11(c_x86_return_11(0), 0);
    ceramic_x86_11(c_x86_return_11(1), 1);

    printf("\nPassing Ceramic return values to C:\n");
    fflush(stdout);

    c_x86_vector(ceramic_x86_return_int_vector(),
        ceramic_x86_return_float_vector(), ceramic_x86_return_double_vector());

    c_x86_2(ceramic_x86_return_2());
    c_x86_3(ceramic_x86_return_3());
    c_x86_4(ceramic_x86_return_4());
    c_x86_5(ceramic_x86_return_5());
    c_x86_6(ceramic_x86_return_6());
    c_x86_7(ceramic_x86_return_7());

    c_x86_10(ceramic_x86_return_10(0), 0);
    c_x86_10(ceramic_x86_return_10(1), 1);

    c_x86_11(ceramic_x86_return_11(0), 0);
    c_x86_11(ceramic_x86_return_11(1), 1);
}
