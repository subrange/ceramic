...
- Pattern guards (`[T when ...]`) and the trailing semicolon mark forward declarations.
...
| Section                           | Contents                                                                                        |
| --------------------------------- | ----------------------------------------------------------------------------------------------- |
| [Primitive Types](types.md)       | `Bool`, integers, floats, pointers, `Array`, `Vec`, `Tuple`, `Union`, `Static`, `ByRef`, …      |
| [Data Access](data-access.md)     | `bitcopy`, `arrayRef`, `tupleRef`, `recordFieldRef`, `recordVariadicField`, enum conversions    |
| [Multiple Values](multiple-values.md) | `countValues`, `nthValue`, `takeValues`, `dropValues`, `integers`                           |
...
| [Introspection](introspection.md) | Symbols, types, records, variants, enums, static strings, modules, lambda types                 |
| [Compiler Interface](compiler.md) | Flags, external function attributes, branch prediction                                          |
